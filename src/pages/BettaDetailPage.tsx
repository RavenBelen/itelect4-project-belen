  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8">
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        <div className="overflow-hidden rounded-2xl bg-slate-900 shadow-sm"><img src={betta.image || "https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=800&auto=format&fit=crop&q=80"} alt={betta.name} className="h-72 w-full object-cover sm:h-80" /></div>
